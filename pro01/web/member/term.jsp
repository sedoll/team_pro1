...
<head>
    ...
    <style>
        ...
        .select_tit {
            font-size:30px; text-align: center; padding-top:1em; color: #2b2b2b;
        }

        <%-- 학생, 선생님 선택 폼 css--%>
        .frm { clear:both; width:1200px; margin:0 auto; padding-top: 40px; display: flex;
        ...
        .inbtn2 { display:block;  border-radius :10px; border-style: none;
            min-width:140px; padding-left: 24px; padding-right: 24px; text-align: center;
            line-height: 48px; background-color: cornflowerblue; color:#fff; font-size: 18px; }
    </style>
