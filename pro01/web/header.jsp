    ...
    <nav class="gnb">
        <ul class="menu">
            ...
            <li class="item2">
                ...
                <ul class="sub">
                    <li><a class="move" href="/board/boardList.jsp">입시 정보</a></li>
                    <li><a class="move" href="/board_stu/boardStuList.jsp">입시 뉴스</a></li>
                    <li><a class="move" href="/board_tea/boardTeaList.jsp">대외 활동 정보</a></li>
                </ul>
            </li>
            <li class="item3">
